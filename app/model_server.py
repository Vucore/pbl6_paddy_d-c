...
MODEL_CLASSIFIER_NAME = "models/best_model_ConViT_v4.pth"
MODEL_DETECTION_NAME = "models/yolov8_best_v3.pt"
...
def run_pipeline(image: Image.Image, model_type: ModelType, conf: float):
    ...
    if len(result_detect[0].boxes) == 0:
        ...
        cv2.putText(orig_img, pred_class, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
        conf_text = f"Threshold: {conf} - Full image classification"
        cv2.putText(orig_img, conf_text, (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
        cv2.putText(orig_img, conf_text, (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 1)
    ...
    for box in result_detect[0].boxes:
        ...
        cv2.putText(orig_img, pred_class, (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
        del crop, crop_pil
    
    conf_text = f"Threshold: {conf}"
    cv2.putText(orig_img, conf_text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
    cv2.putText(orig_img, conf_text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 1)
